...
npx esbuild server/api.ts --bundle --platform=node --format=esm --outfile=dist-server/api-handler.js --external:@neondatabase/serverless --external:@aws-sdk/client-s3 --external:@aws-sdk/lib-storage --external:@aws-sdk/s3-request-presigner --external:busboy 2>&1
echo "Build complete!"
