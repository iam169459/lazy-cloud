...
import { HardDrive, Upload, File, Share2, Trash2, Copy, LogOut, User, Lock, Clock, Download, Loader2, X, ExternalLink, FolderOpen, Eye, Fingerprint, Shield, Coins, ShoppingBag } from 'lucide-react';
    ...
    <div className="min-h-screen" style={{ background: colors.bg, color: colors.text }}>
      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
          ...
          <button onClick={() => nav('/shop')} className="flex items-center gap-3 p-4 rounded-xl transition-all hover:scale-[1.005] text-left" style={{ background: `${colors.accent}10`, border: `1px solid ${colors.accent}30` }}>
            <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0" style={{ background: `${colors.accent}20` }}>
