...
interface Props {
 ...
 <span className="text-gradient">Storage Buckets</span>
 </h2>
 ...
 <div className="p-4 rounded-2xl card" style={{ background: `${colors.text}02`, border: `1px solid ${colors.text}08` }}>
 ...
 {selectedProvider && (
 <div className="mb-6 p-4 rounded-xl border animate-fade-up" style={{ background: `${selectedProvider.color}08`, borderColor: `${selectedProvider.color}20` }}>
 ...
 <button type="submit" disabled={saving} className="flex items-center gap-2 px-6 py-2.5 rounded-xl font-bold text-sm btn btn-primary disabled:opacity-60" style={{ background: colors.gradient, color: colors.bg }}>
 ...
 {/* Provider List */}
 {providers.length === 0 ? (
 <div className="card rounded-2xl py-20 text-center animate-fade-up">
 ...
 <div
 key={p.id}
 className="card rounded-2xl p-5 group animate-fade-up"
