  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4">
        ...
        <p className="text-sm font-mono animate-pulse-glow" style={{ color: colors.textMuted }}>LOADING SECURITY STATUS...</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      <div className="animate-fade-in-up">
        <h2 className="font-semibold flex items-center gap-2">
          ...
          <span className="text-gradient-sci">Security & Time Controls</span>
        </h2>
      ...
      {/* Encryption Section */}
      <div className="card-sci corner-accent rounded-2xl p-5 sm:p-6 animate-fade-in-up delay-100">
        ...
        <div className="flex items-start gap-4 p-4 rounded-xl" style={{ background: `${colors.text}02`, border: `1px solid ${colors.text}08` }}>
          ...
          <button
            ...
            disabled={saving}
            className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold btn-sci disabled:opacity-60"
      ...
      {/* File TTL Section */}
      <div className="card-sci corner-accent rounded-2xl p-5 sm:p-6 animate-fade-in-up delay-200">
        <div className="flex items-center gap-2 mb-4">
          ...
          {fileTTLEnabled && (
            <div className="flex items-center gap-4 animate-fade-in-up">
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm btn-sci disabled:opacity-60"
                style={{ background: colors.gradient, color: colors.bg }}
              >
      ...
      <div className="card-sci corner-accent rounded-2xl p-5 sm:p-6 animate-fade-in-up delay-300">
        <div className="flex items-center gap-2 mb-4">
      ...
      <div className="card-sci corner-accent rounded-2xl p-5 sm:p-6 animate-fade-in-up delay-400">
        <div className="flex items-center gap-2 mb-4">
        ...
        {ipWhitelist.length > 0 ? (
          <div className="space-y-2">
            {ipWhitelist.map((ip, i) => (
              <div key={ip} className="flex items-center gap-3 p-3 rounded-xl animate-fade-in-up" style={{ background: `${colors.text}02`, border: `1px solid ${colors.text}08` }}>
      ...
      <div className="rounded-2xl p-5 animate-fade-in-up delay-500" style={{ background: `${colors.primary}05`, border: `1px solid ${colors.primary}15` }}>
